...
RUN dpkg --add-architecture i386 && apt update && apt install -y wine wine32 wget p7zip-full nano
...
COPY copy_includes.sh /opt/vc/copy_includes.shhttps://github.com/giulioz/vc6-docker/blob/main/Dockerfile
WORKDIR /opt/vc
